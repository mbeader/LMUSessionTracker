...
namespace LMUSessionTracker.Core.Tests.Tracking {
	public class CarHistoryTests {
		...
		public void Update_NoLapsCompleted_NoLaps() {
			history.Update(new() { lapsCompleted = 0 });
		...
		public void Update_OneInvalidLapCompleted_OneLap() {
			history.Update(new() { lapsCompleted = 1, lastSectorTime1 = -1, lastSectorTime2 = -1, lastLapTime = -1 });
		...
		public void Update_OneValidLapCompleted_OneLap() {
			history.Update(new() { lapsCompleted = 1, lastSectorTime1 = 10, lastSectorTime2 = 30, lastLapTime = 60 });
			Assert.Equal(1, history.LapsCompleted);
		...
		public void Update_LapSkipped_TwoLaps() {
			history.Update(new() { lapsCompleted = 2, lastSectorTime1 = 10, lastSectorTime2 = 30, lastLapTime = 60 });
		...
		public void Update_AddOutOfOrder_TwoLaps() {
			history.Update(new() { lapsCompleted = 2, lastSectorTime1 = 10, lastSectorTime2 = 30, lastLapTime = 60 });
			history.Update(new() { lapsCompleted = 1, lastSectorTime1 = 11, lastSectorTime2 = 33, lastLapTime = 66 });
			Assert.Equal(2, history.LapsCompleted);
